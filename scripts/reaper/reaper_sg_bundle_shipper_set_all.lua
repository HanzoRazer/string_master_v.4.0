...
msg("------------------------------------------------------------")
msg("Next steps:")
msg("  1) Run Episode 13 panel: reaper_sg_panel.lua")
msg("  2) Run zero-prompt autorun: reaper_sg_setup_autorun_generate_then_pass.lua")
msg("")
msg("Notes:")
msg("  - session_id controls which session.index.json the UI reads.")
msg("  - host_port is used by scripts that call the server (e.g., /status, /session_index).")
msg("============================================================")
