...
from sg_spec.ai.coach.assignment_v0_5 import OverrideDecisionV0, OverrideReason, CoachFeedbackV0_5
from sg_spec.ai.coach.assignment_v0_6 import AssignmentV0_6, CommitMode, CommitStateV0
