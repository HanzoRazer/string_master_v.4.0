#!/usr/bin/env python3
"""
emit_phrygian_gravity_pack.py

Reads phrygian_gravity_canonical.json and generates playlist YAML files for the
Phrygian Gravity Techniques collection.

Output: playlists/phrygian_gravity_*.ztplay  (1 playlist)
"""
import json
import os
import sys
...
with open(os.path.join(ROOT, "phrygian_gravity_canonical.json"), encoding="utf-8") as f:
    canon = json.load(f)
...
def emit_playlist(pl):
    ...
    lines = [
        f"# Phrygian Gravity -- {pl['title']}",
        f"# Auto-generated from phrygian_gravity_canonical.json",
        "",
        f"id: {pl['id']}",
        f'title: "{pl["title"]}"',
