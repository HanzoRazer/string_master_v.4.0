#!/usr/bin/env python3
"""
emit_minor_gravity_pack.py

Reads minor_gravity_canonical.json and generates playlist YAML files for the
Minor Gravity Techniques collection.

Output: playlists/minor_gravity_*.ztplay  (1 playlist)
"""
import json
import os
import sys
...
with open(os.path.join(ROOT, "minor_gravity_canonical.json"), encoding="utf-8") as f:
    canon = json.load(f)
...
def emit_playlist(pl):
    ...
    lines = [
        f"# Minor Gravity -- {pl['title']}",
        f"# Auto-generated from minor_gravity_canonical.json",
        "",
        f"id: {pl['id']}",
        f'title: "{pl["title"]}"',
